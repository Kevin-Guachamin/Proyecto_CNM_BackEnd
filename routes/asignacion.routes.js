...
const {Docente,DocenteANDReprsentante,docenteVicerrector}=require('../middlewares/protect')
module.exports = (app) => {
    ...
    app.get('/asignacion/obtener/periodo/:periodo',docenteVicerrector ,AsignacionController.getAsignaciones);
