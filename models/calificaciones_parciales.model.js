...
Calificaciones_parciales.belongsTo(Inscripción,{foreignKey: "id_inscripción", targetKey: "ID"})
Inscripción.hasMany(Calificaciones_parciales, {foreignKey: "id_inscripción", sourceKey: "ID"})
